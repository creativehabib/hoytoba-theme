...
export default function Home() {
  return (
      <div className="">
          ...
          {/* Album grid */}
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 border-b-2 pb-3 mb-4">
              <div className="hover:bg-sky-100 transition duration-300 hover:shadow p-2 rounded-xl mb-0">
                  <a href={''}>
                      <img
                          ...
                          alt={'tamheed'}
                          className="object-cover w-50 h-40 mx-auto rounded-xl"
                      />
              ...
              <div className="hover:bg-sky-100 transition duration-300 hover:shadow p-2 rounded-xl">
                  <a href={''}>
                      <img
                          ...
                          alt={'tamheed'}
                          className="object-cover w-50 h-40 mx-auto rounded-xl shadow"
                      />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-5">
              ...
              <Card className="hover:bg-sky-100 transition duration-300 relative">
                  <CardContent className="p-0">
                      <Link href={""}>
                          <h3 className="my-4 mx-5 text-xl">কাঁদিস না ভাই, মন খারাপ করিস না! সাফল্য এপারে নয়, সাফল্য পৃথিবীর ওপারে</h3>
                          <div className="w-full h-60">
                              <img src={'https://cms.bibijaan.com/wp-content/uploads/2015/10/kadis-na-vai-mon-kharap-koris-na.jpg'}
                                   className="h-full"/>
                          </div>
                          <div className="px-6 py-4">
                              ...
                              <div className="mt-5 mb-12 leading-7 text-justify">
                                  <p>গত অল্প কিছুদিনে আমার পরিচিত, বন্ধু, দীনি ভাই, কিংবা আত্মীয় স্বজনদের কাছ থেকে হতাশা দেখতে দেখতে একসময় নিজেই কেমন জানি হতাশ হয়ে পড়েছি। সেখান থেকেই এই লেখাটা লেখা। অন্য কারো জন্য কিনা জানি...</p>
                              </div>
                              <div className="text-sm text-gray-900 flex space-x-2 items-center px-6 py-4 absolute left-0 right-0 bottom-0">
                                  <Calendar size={12}/>
                                  <span>০২ নভেম্বর, ২০১২</span>
              ...
              <Card className="hover:bg-sky-100 transition duration-300 relative">
                  <CardContent className="p-0">
                      <Link href={""}>
                          ...
                          <div className="px-6 py-4">
                              <p className="flex items-center space-x-1"><Feather size={12}/> <span>Zim Tanvir</span></p>
                              <div className="mt-5 mb-12 leading-7 text-justify">
                                  <p>[১] এটা প্রায়ই খুব গর্ব করে দাবি করা হয়, একুশ শতকে মানুষ অনেক এগিয়ে গেছে, অনেক উন্নত হয়েছে, তবে স্থান-কাল-পাত্র ভেদে “এগিয়ে যাওয়া” কিংবা “উন্নতি” – এই শব্দগুলোর অর্থ খুব একটা পরিষ্কার ...</p>
                              </div>
                              <div className="text-sm text-gray-900 flex space-x-2 items-center px-6 py-4 absolute left-0 right-0 bottom-0">
                                  <Calendar size={12}/>
                                  <span>০২ নভেম্বর, ২০১২</span>
